...
export const metadata: Metadata = {
  ...
  description: "Every check the builder runs, what it means, and whether it stops the build or just warns you.",
};
    ...
    <div className="shell py-9 md:py-12">
      <header className="max-w-3xl mb-10">
        ...
        <p className="mt-5 text-[15px] leading-relaxed text-ink-1">
          {total} checks across eight areas. A blocking one means we will not quote the build as it stands, because it
          will not work. A warning means it will work but you should know about it, and you may well have a good
          reason. Notes and suggestions are there so nothing about the machine surprises you after it arrives.
        </p>
