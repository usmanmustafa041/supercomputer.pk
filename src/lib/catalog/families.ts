...
export const CPUS: CpuFamily[] = [
  ...
  { key: "epyc-7742", brand: "AMD", name: "EPYC 7742", segment: "datacenter", year: 2019, usd: 950, socket: "SP3", arch: "Zen 2 (Rome)", cores: 64, threads: 128, base: 2.25, boost: 3.4, l3: 256, tdpW: 225, maxW: 240, memGen: "ddr4", memCh: 8, memKinds: ["rdimm", "lrdimm"], maxMemGb: 4096, memMts: 3200, ecc: true, pcieGen: 4, lanes: 128, maxSockets: 2, igpu: false, boxed: false, avx512: false, amx: false, conditions: LEGACY_COND, highlights: ["64 cores under PKR 300k as a tested pull", "Rome is slower per-clock than Milan but the core count is free", "Check the board supports Rome without a BIOS update"], tags: ["value", "budget", "dense"] },
...
export const PSUS: PsuFamily[] = [
  ...
  { key: "smc-crps", brand: "Supermicro", name: "CRPS Redundant Module", segment: "datacenter", year: 2021, usd: 0, usdPerKw: 260, watts: [1200, 1600, 2000, 2600], form: "crps", eff: "80+ platinum", atx: "2.4", modular: "none", conn: {}, redundancy: 2, vMin: 100, derate230: 1.0, depthMm: 185, conditions: ["new", "refurb-a", "pull"], highlights: ["1+1 redundant — pull one module live and the node keeps running", "Above 1600W these need 200V+ input, which Pakistani mains supplies", "Hot-swap from the rear"], tags: ["redundant", "hotswap", "rack", "platinum"] },
  { key: "smc-crps-2u-hi", brand: "Supermicro", name: "CRPS 2U High-Output", segment: "datacenter", year: 2023, usd: 0, usdPerKw: 300, watts: [3000, 3200, 5250], form: "redundant-2u", eff: "80+ titanium", atx: "2.4", modular: "none", conn: {}, redundancy: 2, vMin: 200, derate230: 1.0, depthMm: 265, conditions: ["new"], highlights: ["Feeds an 8-GPU node — 5250W in a 2+2 arrangement", "200-240V input only; will not start on 110V", "Titanium efficiency matters at this draw"], tags: ["redundant", "rack", "titanium", "gpu-dense", "high-power"] },
];
