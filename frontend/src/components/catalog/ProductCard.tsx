    ...
    <Link href={`/product/${p.slug}`} className="panel-int ticked group flex flex-col">
      ...
      <div className="p-3.5 flex flex-col flex-1 gap-3">
        ...
        <div className="flex items-end justify-between gap-2 pt-2 border-t border-[var(--line)]">
          <div>
            {/* 11px and tighter tracking so it holds one line in a grid cell.
                At 12px "Request a quote" wrapped in most of them. */}
            <div className="t-data text-[11px] font-medium text-acc uppercase tracking-[0.04em] whitespace-nowrap">
              Request a quote
            </div>
