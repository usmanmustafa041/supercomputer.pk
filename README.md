...
Next.js 16 (App Router), React 19, Tailwind v4, TypeScript. PostgreSQL is the catalog authority; `shared/` provides seed data and compatibility logic.

```
npm install
npm run dev:web      # http://localhost:3000
npm run check        # typecheck + lint + compatibility engine tests
npm run up:dev       # Docker with local API/database/MinIO ports
```
